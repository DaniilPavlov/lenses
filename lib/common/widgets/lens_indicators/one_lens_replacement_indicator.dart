...
class OneLensReplacementIndicator extends StatelessWidget {
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              DateInfoLine(isLeft: isLeft, hasIcon: !sameTime),
              Padding(
  ...
  void _showPutOnSheet(
    ...
    showModalBottomSheet<num>(
      ...
      barrierColor: Colors.black.withValues(alpha: 0.8),
      builder: (context) {
        return (leftLensDate != null) ^ (rightLensDate != null)
            ? PutOnDateSheet(
                leftPut: leftLensDate == null ? DateTime.now() : null,
                rightPut: rightLensDate == null ? DateTime.now() : null,
                onConfirmed: ({leftDate, rightDate}) =>
                    controller.updateLensesPair(leftDate: leftDate, rightDate: rightDate),
              )
